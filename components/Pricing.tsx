...
const PricingCard: React.FC<{ plan: Plan }> = ({ plan }) => (
  <motion.div
    ...
    className={`relative flex flex-col p-8 rounded-lg border transition-all duration-300 ${plan.isPopular
  ...
  >
    ...
    <button className={`w-full py-4 text-xs font-bold tracking-widest uppercase rounded transition-all ${plan.isPopular
