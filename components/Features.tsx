                ...
                >
                    <div className="max-w-2xl">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed max-w-xl">
                            More than just a spellchecker. Access a fast, powerful writing system designed to help you write better, faster, and more efficiently.
                        </p>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="mt-12 lg:mt-0">
                                <h3 className="text-2xl font-display font-medium text-white mb-3">Grammar Polish</h3>
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="mt-12 lg:mt-0">
                                <h3 className="text-xl font-display font-medium text-white mb-3">Tone Shift</h3>
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="mt-12 lg:mt-0">
                                <h3 className="text-xl font-display font-medium text-white mb-3">Smart Draft</h3>
                                <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="mt-12 lg:mt-0">
                                <h3 className="text-2xl font-display font-medium text-white mb-3">Use any LLM</h3>
                                <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                                    Starstrike works with any LLM. Thanks to OpenRouter, you can use any LLM you want. Some are free!
